...
export default function ExpenseModal({ onClose, onSuccess }: ExpenseModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-end lg:items-center justify-center z-50">
      <div className="bg-white rounded-t-2xl lg:rounded-lg shadow-xl w-full lg:max-w-xl max-h-[85vh] lg:max-h-[90vh] lg:mx-4 flex flex-col overflow-hidden">
        {/* Header */}
        ...
        <div className="border-t border-gray-200 px-4 lg:px-6 py-3 lg:py-4 bg-gray-50 pb-safe">
          <div className="flex gap-2 lg:gap-3">
            <button type="button" onClick={onClose} className="btn-secondary flex-1 py-2.5 lg:py-2">
              Cancel
            </button>
            <button
