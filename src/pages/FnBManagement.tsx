...
export default function FnBManagement({ menuItems, bundles = [], onSaveMenuItems, onSaveBundles, userRole }: FnBManagementProps) {
  ...
  return (
    <div className="h-full bg-gray-50 p-4 overflow-hidden flex flex-col">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-2 lg:p-3 mb-2">
        <p className="text-[10px] text-gray-500 mb-1.5 lg:hidden">Add new menu item:</p>
        <div className="flex flex-col lg:flex-row gap-2">
          <div className="flex items-center gap-2 flex-1">
            <input
              ...
              className="input flex-1 text-xs lg:text-sm"
            />
            <input
              type="number"
              placeholder="Price"
              ...
              className="input w-16 lg:w-20 text-xs lg:text-sm"
            />
          </div>
          <div className="flex items-center gap-2">
            <select
              ...
              className="input flex-1 lg:w-auto text-xs"
            >
              {categories.map(cat => (
            ...
            <button
              ...
              className="px-3 py-1.5 text-xs bg-slate-800 text-white rounded-lg hover:bg-slate-900 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1"
            >
